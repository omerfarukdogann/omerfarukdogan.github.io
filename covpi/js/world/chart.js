...
const Corona = {
  ...
  getLocationData: () => {
    ...
    fetch(_0x9df8cf, { method: "GET" })
      [_0x2577("0xa")]((_0x724a49) => _0x724a49[_0x2577("0xd")]())
      [_0x2577("0xa")]((_0x4be7fd) => {
        ...
        datasets: [
          {
            data: [
              _0x4dfd59["cases"],
              _0x4dfd59["deaths"],
              _0x4dfd59[_0x2577("0x4")],
            ],
            backgroundColor: [_0x2577("0x3"), _0x2577("0x7"), "#03dac5"],
            borderWidth: 0x0,
          },
        ],
      },
